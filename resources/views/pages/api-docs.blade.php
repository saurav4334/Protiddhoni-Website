...
<title>API Documentation — Protiddhoni Voice Broadcasting</title>
<meta name="description" content="Protiddhoni REST API v1.0 reference — Voice OTP, multi-number broadcasts, surveys, webhooks, and sender management for Bangladesh. Base URL: api.protiddhoni.com/api" />
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600;700&family=Hind+Siliguri:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
:root{
...
<nav class="nav">
  <div class="container nav-inner">
    ...
    <div class="nav-cta">
      ...
      <a class="btn btn-primary" href="/contact">Get API token</a>
    </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="/api-docs#error-responses">Error responses</a></li>
...
<script>CMS.init({ base: window.PROTIDDHONI_CMS_BASE || '/api', page: 'api-docs' });</script>
</body>
</html>
