...
<title>Voice OTP — Protiddhoni</title>
<meta name="description" content="Bangla voice OTP that actually delivers. 99.4% delivery across all 4 BD carriers in under 2 seconds. Trusted by banks, MFS, and e-commerce." />
...
<nav class="navbar">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      <a href="/voice-otp" class="active">Voice OTP</a>
    ...
    <div class="hero-grid">
      ...
      <div class="phone-mock">
        ...
        <div class="call-notif">
          ...
          <div class="ci-meta">
            <div class="ci-name">Protiddhoni OTP</div>
        ...
        <div class="phone">
          <div class="phone-screen">
            ...
            <div class="phone-content">
              <div class="otp-app">Protiddhoni OTP</div>
    ...
    <div class="why-grid">
      ...
      <div class="vs-card reveal">
        <div class="vs-row head">
          ...
          <div class="vs-cell" style="background:linear-gradient(180deg,#FFF9E6,#fff);color:var(--navy)">Protiddhoni OTP</div>
        </div>
        <div class="vs-row">
...
<span class="k">const</span> voice = <span class="k">require</span>(<span class="s">'@protiddhoni/voice'</span>);
...
<span class="k">from</span> protiddhoni <span class="k">import</span> Client
...
<span class="k">use</span> Protiddhoni\Voice\Client;
...
curl -X POST https://api.protiddhoni.bd/v1/otp/send \
  ...
  <div class="container">
    <div class="reveal">
      <div class="testi-quote">
        After migrating to Protiddhoni's Voice OTP, our transaction completion rate climbed from <strong style="color:var(--blue)">63% to 89%</strong>. In the past 6 months not a single failed delivery has slipped past our monitoring.
      </div>
...
<script>CMS.init({ base: window.PROTIDDHONI_CMS_BASE || '/api', page: 'voice-otp' });</script>
</body>
</html>
