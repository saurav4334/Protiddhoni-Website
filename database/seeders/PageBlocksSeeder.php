...
class PageBlocksSeeder extends Seeder
{
    ...
    {
        return [
            ['key' => 'global.brand.name',       'label' => 'Brand name',          'page' => 'global', 'type' => 'text', 'value' => 'Protiddhoni'],
    ...
    private function homepage(): array
    {
        return [
            ...
            ['key' => 'homepage.testimonials',  'label' => 'Homepage testimonials', 'page' => 'homepage', 'type' => 'json',
             'value' => json_encode([
                 ['name' => 'Sajid Rahman', 'role' => 'CTO, bKash', 'quote' => 'SMS used to fail in rural areas — that was our biggest pain. After switching to Protiddhoni, our delivery rate climbed from 78% to 99%.'],
                 ...
                 ['name' => 'Dr. Hasan',    'role' => 'Programs Director, BRAC', 'quote' => "We needed to reach 4 lakh households for a health awareness campaign. Protiddhoni's coverage and reporting saved our compliance team."],
             ])],
    ...
    private function voiceBroadcast(): array
    {
        return [
            ...
            ['key' => 'voice-broadcast.hero.headline', 'label' => 'Hero headline', 'page' => 'voice-broadcast', 'type' => 'rich_text',
             'value' => 'Reach lakhs of customers <span class="grad">in one announcement.</span>'],
    ...
    private function pricing(): array
    {
        return [
            ...
            ['key' => 'pricing.tiers', 'label' => 'Pricing plan tiers', 'page' => 'pricing', 'type' => 'json',
             'value' => json_encode([
                 ['name' => 'Starter',    'price_monthly' => 999,  'price_yearly' => 799,  'description' => 'For solopreneurs, students, and small projects testing voice OTP or surveys.', 'features' => ['1,000 calls/month included', 'All 4 BD carriers', 'Bangla + English TTS', 'Email support']],
                 ['name' => 'Business',   'price_monthly' => 4999, 'price_yearly' => 3999, 'description' => 'For e-commerce, NGOs, and growth teams running regular broadcasts and OTP at scale.', 'features' => ['10,000 calls/month included', 'Custom voices', 'Priority support', 'API access', 'Webhooks', 'BTRC reporting'], 'featured' => true],
                 ['name' => 'Enterprise', 'price_monthly' => 'Custom', 'price_yearly' => 'Custom', 'description' => 'For banks, MFS, and govt-scale operations needing dedicated infra and SLAs.', 'features' => ['Unlimited calls', 'Dedicated infra', '99.95% SLA', '24/7 support', 'Custom contracts', 'On-prem option']],
             ])],
    ...
    private function apiDocs(): array
    {
        return [
            ...
            ['key' => 'api-docs.hero.headline', 'label' => 'Hero headline', 'page' => 'api-docs', 'type' => 'rich_text',
             'value' => 'Voice broadcasting API <span class="grad">for Bangladesh.</span>'],
